...
[![test](https://github.com/juan-vg/wait-for-status-checks/actions/workflows/test.yaml/badge.svg)](https://github.com/juan-vg/wait-for-status-checks/actions/workflows/test.yaml)

Forked from [poseidon/wait-for-status-checks](https://github.com/poseidon/wait-for-status-checks)
...
jobs:
  enforce-all-checks:
    ...
    steps:
      - name: GitHub Checks
        uses: juan-vg/wait-for-status-checks@v0.6.0
        with:
